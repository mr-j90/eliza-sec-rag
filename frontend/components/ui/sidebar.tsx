...
function SidebarInset({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        // min-w-0: without it this flex item sizes to its content's min width,
        // so wide tables push the whole pane past the viewport instead of
        // scrolling inside their own overflow containers.
